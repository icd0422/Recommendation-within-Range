...
public class MainActivity extends AppCompatActivity {
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            target = "http://icd0422.cafe24.com/hit_music.php";
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                while (c < jsonArray.length()) {
                    ...
                    adapter.addItem(new MusicItem(object.getString("title"),object.getString("singer"),object.getString("high_octave"),object.getString("link")));
    ...
    public class MusicItemView extends LinearLayout
    {
        ...
        public void init(Context context) {
            ...
            inflater.inflate(R.layout.hit_music_item, this, true) ;
    ...
    public class MusicItem
    {
        ...
        public MusicItem(String a, String b, String c, String d) {
            title = a;
            singer = b;
            high_octave = c;
            LinkString = d ;
    ...
    class MusicAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            view.setLink(item.getLinkString());
